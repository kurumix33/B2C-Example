<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\pp\PHPTutorial\WWW\tp\public/../application/admin\view\index\index.html";i:1558146297;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<!--     <li><a href="info.html" target="right"><span class="icon-caret-right"></span>网站设置</a></li> -->
    <li><a href="<?php echo url('admin/Pass/pass'); ?>" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
    <li><a href="<?php echo url('admin/Adv/adv'); ?>" target="right"><span class="icon-caret-right"></span>产品管理</a></li>  
